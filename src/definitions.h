...
#define DECODE 1
#define MEM_ADDR_CALC 2 // AZ NOTE: Maybe rename to MEM_ADDR_CALC to catch students using old submissions
#define MEM_LD_READ 3 // Rename to MEM_LD_READ?
#define WB_STEP 4
#define MEM_ST_WRITE 5 // Rename to MEM_ST_WRITE?
#define EXEC 6
